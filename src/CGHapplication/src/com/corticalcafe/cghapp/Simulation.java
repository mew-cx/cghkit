...
public class Simulation implements Runnable {
    ...
    static boolean randomPhase = false;
...
//    plate.initializePlate(500,500,(670e-9)/16.); //set sample at 1/16 wavelength
    ...
    public void initializeSimulation() {
        ...
        if (randomPhase) {
//            object.debug("pre rand");
            randomizeObjectPhases();
//            object.debug("post rand");
        }
...
//    }
    ...
    public String getStatus() {
        ...
        if (!multiThread) {
            ...
            } else //      return ""+(int)(100*getCurrentRayNumber()/getTotalRayCount())+" % completed";
            {
